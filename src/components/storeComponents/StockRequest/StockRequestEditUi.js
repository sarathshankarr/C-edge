...
const StockRequestEditUi = ({route, ...props}) => {
  ...
  const RemoveRow = id => {
    ...
    const filtered = stockTable.filter(item => item.id !== id);
    set_stockTable(filtered);
  };
      ...
      <View style={{marginBottom: hp('5%')}}>
        <KeyboardAwareScrollView
          ...
          <View
            ...
            <TextInputComponent
              inputText={
                props?.itemsObj?.stylename ? props.itemsObj.stylename : ''
              }
              labelText={'Styles'}
              isEditable={false}
              maxLengthVal={200}
          ...
          <View
            ...
            <TextInputComponent
              inputText={
                props?.itemsObj?.approvedFabric
                  ? `${props?.itemsObj?.approvedFabric} (${props?.itemsObj?.approvedFabricConsumption})`
                  : ''
              }
          ...
          <View
            ...
            <TextInputComponent
              inputText={
                props?.itemsObj?.allowanceFabric
                  ? props?.itemsObj?.allowanceFabric
                  : ''
              }
          ...
          <View
            ...
            <TextInputComponent
              inputText={
                props?.itemsObj?.totalFabricApprovedWithAllowance
                  ? props?.itemsObj?.totalFabricApprovedWithAllowance?.toString()
                  : ''
              }
          ...
          <View
            ...
            <TextInputComponent
              inputText={
                props?.itemsObj?.availFabricQty
                  ? props?.itemsObj?.availFabricQty?.toString()
                  : ''
              }
          ...
          <View
            ...
            <TextInputComponent
              inputText={
                props.itemsObj?.uomfabric ? props.itemsObj?.uomfabric : ''
              }
            ...
            <TextInputComponent
              inputText={
                props?.itemsObj?.fabricqty
                  ? props?.itemsObj?.fabricqty.toString()
                  : ''
              }
          ...
          <View style={styles.wrapper}>
            <View style={styles.table}>
              ...
              <View style={styles.table_body_single_row}>
                <View style={{width: '50%'}}>
                  <Text style={styles.table_head_captions2}>
                    Requested Date
                  </Text>
                </View>
                <View style={{width: '50%'}}>
                  <Text style={styles.table_data}>
                    {data?.requestedDateStr}
                  </Text>
                </View>
              </View>
            </View>

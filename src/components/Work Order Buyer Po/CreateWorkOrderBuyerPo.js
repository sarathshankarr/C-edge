...
import CreateWorkOrderBuyerPoUI from './CreateWorkOrderBuyerPoUI';

const CreateWorkOrderBuyerPo = ({ route }) => {
...
export default CreateWorkOrderBuyerPo;

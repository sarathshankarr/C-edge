...
import CreateLocationMasterUI from './CreateLocationMasterUI';

const CreateLocationMasterComponent = ({ route }) => {
...
export default CreateLocationMasterComponent;

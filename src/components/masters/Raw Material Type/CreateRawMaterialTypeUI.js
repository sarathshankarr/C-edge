...
const CreateRawMaterialTypeUI = ({route, navigation, ...props}) => {
  const [rmType, set_rmType] = useState('');
    ...
    <View style={[CommonStyles.mainComponentViewStyle]}>
      <View style={[CommonStyles.headerView]}>
        <HeaderComponent
          ...
          title={'Create Raw Material Type'}
        ...
        <View
          ...
          <View style={{marginTop: hp('2%')}}>
            <TextInput
              ...
              value={rmType}
              mode="outlined"
              onChangeText={text => set_rmType(text)}
            />
          </View>
          <View style={{marginTop: hp('2%')}}>
            <TextInput
              ...
              value={rmTypeCode}
              mode="outlined"
              onChangeText={text => set_rmTypeCode(text)}
            />
          </View>
          ...
          <View
            ...
            <RadioGroup
              ...
              layout="row"
              selectedId={
                bomStatusRadioButtons.find(item => item.value === bomStatus)?.id
              }
            />
          </View>
        </View>
...
export default CreateRawMaterialTypeUI;

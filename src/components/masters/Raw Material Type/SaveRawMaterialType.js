...
import SaveRawMaterialTypeUI from './SaveRawMaterialTypeUI';

const SaveRawMaterialType = ({ navigation, route, ...props }) => {
...
export default SaveRawMaterialType;

...
const SeasonMasterListUI = ({route, navigation, ...props}) => {
    ...
    <View style={[CommonStyles.mainComponentViewStyle]}>
      <View style={[CommonStyles.headerView]}>
        <HeaderComponent
          ...
          title={'Season Group  Master List'}
    ...
    />
    {
      ...
      <Text style={{ color: '#7F7F81', fontSize: 14 }}>{"Filter"}</Text> 
        ...
        {!props.MainLoading ? <Text style={[CommonStyles.tylesHeaderTextStyle, {fontSize: 18}]}>{Constant.noRecFound}</Text> : null}
                 ...
                 title="Season Group  Master Edit"
                 color="#841584"
     ...
     <AddNewItem navItem={'CreateSeasonMasterComponent'}/>
...
export default SeasonMasterListUI;

...
import CreateScaleOrSizeMasterUI from './CreateScaleOrSizeMasterUI';

const CreateScaleOrSizeComponent = ({ route }) => {
...
export default CreateScaleOrSizeComponent;

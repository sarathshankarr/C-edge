...
import SaveScaleOrSizeMasterUI from './SaveScaleOrSizeMasterUI';

const SaveScaleOrSizeMaster = ({ navigation, route, ...props }) => {
...
export default SaveScaleOrSizeMaster;

...
import RawMaterialsMasterListUI from './RawMaterialsMasterListUI';

const RawMaterialsMasterList = ({ route }) => {
...
export default RawMaterialsMasterList;

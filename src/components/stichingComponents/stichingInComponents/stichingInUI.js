...
const StichingInUI = ({route, ...props }) => {
  ...
  const filterPets = (name) => {
   ...
   setIsFiltering(true); 
    ...
    const styleArray = ItemsArray.filter(style => (style.styleNo.toString().toUpperCase().includes(name.toUpperCase()) || style.color.toUpperCase().includes(name.toUpperCase()) || style.wNo.toUpperCase().includes(name.toUpperCase())));
          ...
          <View style={{ flex: 3 }}>
            ...
            <Text style={CommonStyles.tylesTextStyle}>
             {item.color} {' '}
              ...
              <Text style={{ fontWeight: '600' }}>{item.wNo}</Text>
              <Text style={{ fontWeight: 'bold' }}> )</Text>
            </Text>
          </View>
  ...
  >
    ...
    />
    {
      ...
      <FilterModal
        ...
        selectedCategoryListAPI={'getSelectedCategoryList_stitchingIn'}

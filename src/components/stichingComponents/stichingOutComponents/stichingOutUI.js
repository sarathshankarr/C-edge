...
const StichingOutUI = ({route, ...props }) => {
  ...
  //         <Text style={[CommonStyles.tylesTextStyle,{flex:1,textAlign:'right'}]}>{item.receivedStitchOutQty+"/"}<Text style={[CommonStyles.tylesTextStyle,{flex:1,textAlign:'right'}]}>{item.stitchQty}</Text></Text>

...
import { View, FlatList, Text, Image, TouchableOpacity, ScrollView, StyleSheet, TextInput } from 'react-native';
  ...
  return (
    ...
    <View style={[CommonStyles.mainComponentViewStyle]}>
      ...
      <View style={{ marginBottom: hp('5%') }}>
        ...
        <KeyboardAwareScrollView enableOnAndroid={true} extraHeight={100} extraScrollHeight={100} showsVerticalScrollIndicator={false}>

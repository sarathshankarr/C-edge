      ...
      <View style={{ marginBottom: hp('5%'), width: '100%' }}>
        ...
        <KeyboardAwareScrollView enableOnAndroid={true} extraHeight={130} extraScrollHeight={130} showsVerticalScrollIndicator={false}>
          ...
          <View style={{ alignItems: 'center', justifyContent: 'center', marginTop: hp('1%') }} >
            ...
            <TextInputComponent
              inputText={props?.itemsObj[0] && props?.itemsObj[0][0]?.styleName ? props?.itemsObj[0][0]?.styleName : ''}
          ...
          <View style={{ alignItems: 'center', justifyContent: 'center', marginTop: hp('1%') }} >
            <TextInputComponent
              inputText={props?.itemsObj[0] && props?.itemsObj[0][0]?.styledesc ? props?.itemsObj[0][0]?.styledesc : ''}
          ...
          <View style={{ alignItems: 'center', justifyContent: 'center', marginTop: hp('1%') }} >
            <TextInputComponent
              inputText={props?.itemsObj[0] && props?.itemsObj[0][0]?.shipqty ? props?.itemsObj[0][0]?.shipqty : ''}
              labelText={'Ship Qty'}
              isEditable={false}
              maxLengthVal={200}
              autoCapitalize={"none"}
          ...
          <View style={{ alignItems: 'center', justifyContent: 'center', marginTop: hp('1%') }} >
            <TextInputComponent
              inputText={props?.itemsObj[0] && props?.itemsObj[0][0]?.username ? props?.itemsObj[0][0]?.username : ''}
              labelText={'User Name'}
              isEditable={false}
              maxLengthVal={200}
              autoCapitalize={"none"}
          ...
          <View style={{ alignItems: 'center', justifyContent: 'center', marginTop: hp('1%') }} >
            <TextInputComponent
              inputText={props?.itemsObj[0] && props?.itemsObj[0][0]?.woNo ? props?.itemsObj[0][0]?.woNo : ''}
          ...
          {stockTable?.length > 0 && stockTable.map((table, tableIndex) => (
            <View key={tableIndex} style={styles.wrapper}>
              <View style={styles.table}>
                {/* Table Head */}
                <View style={styles.table_head}>
                  <View style={{ width: '35%' }}>
                    <Text style={styles.table_head_captions1}>Process Name</Text>
                  </View>
                  <View style={{ width: '1%' }} />
                  <View style={{ width: '15%' }}>
                  ...
                  <View style={{ width: '2%' }} />
                  <View style={{ width: '15%' }}>
                    <Text style={styles.table_head_captions}>Balance Qty</Text>
                  </View>
                </View>
                ...
                {table.map((item, index) => (
                  <View key={index} style={[
                    ...
                    item.processTotQty <= item.totQty && item.damagedqty === 0 && item.totQty !== 0 && { backgroundColor: 'lightgreen' },
                    item.processTotQty > item.totQty && item.damagedqty === 0 && item.totQty !== 0 && { backgroundColor: 'yellow' },
                    ...
                    <View style={{ width: '1%' }} />
                    <View style={{ width: '15%' }}>
                      <Text style={styles.table_data}>{item.processTotQty}</Text>
                    </View>
                    <View style={{ width: '1%' }} />
                    <View style={{ width: '15%' }}>
                    ...
                    <View style={{ width: '1%' }} />
                    <View style={{ width: '15%' }}>
                      <Text style={styles.table_data}>{item.damagedqty}</Text>
                    </View>
                    <View style={{ width: '2%' }} />
                    <View style={{ width: '15%' }}>

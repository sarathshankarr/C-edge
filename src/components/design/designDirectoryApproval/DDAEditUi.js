...
// console.log("props ===> ", props.itemsObj)
      ...
      if (props?.itemsObj?.fabricId) {
        ...
        set_fabricName(
          props?.itemsObj?.loadFabricStyles[props.itemsObj.fabricId],
        );
      ...
      if (props?.itemsObj?.design_farma_id) {
        ...
        set_farmaName(
          props?.itemsObj?.farmaMap[props.itemsObj.design_farma_id],
        );
      }
      ...
      if (props?.itemsObj?.cap_category_id) {
        ...
        set_capCategoryName(
          props?.itemsObj?.capcategoryMap[props.itemsObj.cap_category_id],
        );
      }
      ...
      if (props?.itemsObj?.sizegroupId) {
        ...
        set_seasonName(
          props?.itemsObj?.sizeGroupsMap[props.itemsObj.sizegroupId],
        );
      }
      ...
      if (props?.itemsObj?.sizeRangeId) {
        ...
        set_scaleName(
          props?.itemsObj?.sizeRangesMap[props.itemsObj.sizeRangeId],
        );
      }
      ...
      <View style={{marginBottom: hp('5%')}}>
        <KeyboardAwareScrollView
                ...
                <View style={[styles.SectionStyle1, {}]}>
                  <View style={{flexDirection: 'column'}}>
                    ...
                    <Text style={[styles.dropTextInputStyle]}>
                      {locationName ? locationName : 'select'}
                    </Text>
                  </View>
                </View>
              </View>
              ...
              <View>
                <View style={[styles.SectionStyle1, {}]}>
                  <View style={{flexDirection: 'column'}}>
                    ...
                    <Text style={[styles.dropTextInputStyle]}>
                      {capCategoryName ? capCategoryName : 'select'}
                    </Text>
                  </View>
                </View>
              </View>
              ...
              <View>
                <View style={[styles.SectionStyle1, {}]}>
                  <View style={{flexDirection: 'column'}}>
                    ...
                    <Text style={[styles.dropTextInputStyle]}>
                      {closureName ? closureName : 'select'}
                    </Text>
                  </View>
                </View>
              </View>
          ...
          <View
            ...
            <TextInputComponent
              inputText={
                props.itemsObj ? props?.itemsObj?.front_logo_image : ''
              }
          ...
          <View
            ...
            <TextInputComponent
              inputText={
                props.itemsObj ? props?.itemsObj?.visor_logo_image : ''
              }
          ...
          <View style={{marginTop: 20, marginBottom: 30}}>
            <Text
              style={[
                ...
                {alignItems: 'center', marginLeft: 10, fontSize: 18},
              ]}>
              {'Remarks  :'}
            </Text>
            <View
          ...
          <View
            ...
            <Image
              source={{
                uri: `data:image/png;base64,${props?.itemsObj?.designImg}`,
              }}
          ...
          <View
            ...
            <TextInputComponent
              inputText={
                props.itemsObj ? props?.itemsObj?.rightside_logo_image : 'N/A'
              }
          ...
          <View
            ...
            <TextInputComponent
              inputText={
                props.itemsObj ? props?.itemsObj?.leftside_logo_image : ''
              }
          ...
          <View
            ...
            <TextInputComponent
              inputText={
                props.itemsObj ? props?.itemsObj?.inside_printing_tape : ''
              }
          ...
          <View
            style={{
              ...
              justifyContent: 'center',
              marginTop: hp('1%'),
              backgroundColor: editStatus ? '#ffffff' : '#dedede',
              width: '90%',
              alignSelf: 'center',
            }}>
            <TouchableOpacity
              ...
              onPress={() => {
                set_showStatusArrayList(!showStatusArrayList);
              }}>
              <View>
                <View style={[styles.SectionStyle1, {}]}>
                  <View style={{flexDirection: 'column'}}>
                    ...
                    <Text style={[styles.dropTextInputStyle]}>
                      {statusArrayName ? statusArrayName : 'Select Status'}
                    </Text>
                  </View>
                </View>
              </View>

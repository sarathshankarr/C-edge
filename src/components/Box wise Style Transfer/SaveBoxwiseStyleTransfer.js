...
import SaveBoxwiseStyleTransferUI from './SaveBoxwiseStyleTransferUI';

const SaveBoxwiseStyleTransfer = ({navigation, route, ...props}) => {
  ...
  const getInitialData = async id => {
    ...
    let EditFabricProcessInObj =
      await APIServiceCall.getEditDetailsBoxWiseStyleTransfer(obj);
    set_isLoading(false);
  ...
  const submitAction = async tempObj => {
    ...
    let SAVEAPIObj = await APIServiceCall.saveEditBoxWiseStyleTransfer(
      tempObj,
    );
    set_isLoading(false);
...
export default SaveBoxwiseStyleTransfer;

...
import CreateNewProcessOutUI from './CreateNewProcessOutUI';

const CreateNewProcessOut = ({route}) => {
  ...
  const getData = async () => {
    ...
    let LISTAPIOBJ = await APIServiceCall.getCreateNewProcessOut(obj);
    set_isLoading(false);
...
export default CreateNewProcessOut;

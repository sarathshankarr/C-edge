...
import NewProcessOutListUI from './NewProcessOutListUI';

const NewProcessOutList = ({route}) => {
  ...
  const getInitialData = async (page = 0, reload = false) => {
    ...
    try {
      let obj = {
        ...
        searchKeyValue: 'SO12345',
        styleSearchDropdown: 'ALL',
        dataFilter: '30',
        loginDTO: {
          vendorId: userId,
          loginType: 'Admin',
      ...
      let LISTAPIOBJ = await APIServiceCall.LoadAllInhouseProductionNewOut(obj);
      set_isLoading(false);
...
export default NewProcessOutList;

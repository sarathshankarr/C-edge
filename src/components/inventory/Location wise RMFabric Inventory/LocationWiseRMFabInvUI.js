...
const LocationWiseRMFabInvUI = ({route, ...props }) => {
  ...
  const [categories, set_categories]=useState([
    ...
    { id: "rmFabricNames", fid: "rmFabName", value: "RM/Fabric Name" , idxId:"fabric_rm_Id"},
    ...
    />
    {
      ...
      <Text style={{ color: '#7F7F81', fontSize: 14 }}>{"Filter"}</Text> 
        ...
        {filterArray && filterArray.length > 0 ? <View style={CommonStyles.listCommonHeader}>
          ...
          <Text style={[CommonStyles.tylesHeaderTextStyle,{flex:1,textAlign:'center',}]}>{'WO'}</Text> */}
          <View style={{ width:30 }} />
          <Text style={[CommonStyles.tylesHeaderTextStyle,{textAlign:'left', flex:1}]}>{'UOM'}</Text>
      ...
      <FilterModal
        ...
        selectedCategoryListAPI={'getSelectedCategoryList_LocationwiseRMFabricInventory'}

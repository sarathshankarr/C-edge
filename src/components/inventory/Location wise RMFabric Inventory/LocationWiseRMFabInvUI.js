...
const LocationWiseRMFabInvUI = ({route, ...props}) => {
  ...
  const [categories, set_categories] = useState([
    ...
    {id: 'units', fid: 'uom', value: 'Unit', idxId: 'uomId'},
  ]);
  ...
  //     const styleArray = nestedFilter.filter(style => (style.styleNo.toString().toUpperCase().includes(recName.toUpperCase()) || style.color.toUpperCase().includes(recName.toUpperCase()) || style.wNo.toUpperCase().includes(recName.toUpperCase())));
  ...
  const filterPets = name => {
    ...
    const styleArray = ItemsArray.filter(
      style =>
        style.locationName?.toUpperCase().includes(name?.toUpperCase()) ||
        style.rmFabName.toUpperCase().includes(name?.toUpperCase()) ||
        style.uom.toUpperCase().includes(name?.toUpperCase()),
    );
      ...
      <TouchableOpacity
        ...
        <View style={{flexDirection: 'row', alignItems: 'center'}}>
          <View style={{flex: 3}}>
            ...
            <Text style={[CommonStyles.tylesTextStyle, {fontWeight: '400'}]}>
              {item.rmFabName}
            </Text>
          ...
          <View style={{width: 30}} />
          <View style={{flex: 1}}>
            <Text style={CommonStyles.tylesTextStyle}>{item.uom}</Text>
          </View>
          <View style={{flex: 1}}>
    ...
    <View style={[CommonStyles.mainComponentViewStyle]}>
      <View style={[CommonStyles.headerView]}>
        <HeaderComponent
          ...
          title={'Location wise RM/Fabric Inventory'}
      ...
      <FilterModal
        ...
        selectedCategoryListAPI={
          'getSelectedCategoryList_LocationwiseRMFabricInventory'
        }
...
export default LocationWiseRMFabInvUI;

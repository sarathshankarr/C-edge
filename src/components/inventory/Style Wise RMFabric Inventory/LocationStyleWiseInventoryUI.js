      ...
      <TouchableOpacity onPress={() => actionOnRow(item, index)} style={CommonStyles.cellBackViewStyle}>
        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
          <View style={{ flex: 3 }}>
            ...
            {item.rmFabName && (<Text style={[CommonStyles.tylesTextStyle ,{fontWeight:'400'}]}>
            {item.rmFabName} 
            </Text>)}
            {item.styleName && <Text style={[CommonStyles.tylesTextStyle, {fontWeight:'400'}]}>
              <Text style={{fontWeight:'500'}}>{'Style : '}</Text>
            {item.styleName}
            </Text>}
           {item.size && <Text style={[CommonStyles.tylesTextStyle, {fontWeight:'400'}]}>
    ...
    <View style={[CommonStyles.mainComponentViewStyle]}>
      ...
      <View style={[CommonStyles.headerView]}>
        <HeaderComponent
          ...
          title={'Style Wise RM/Fabric Inventory'}

...
import SavePartProcessingUI from './SavePartProcessingUI';

const SavePartProcessing = ({navigation, route, ...props}) => {
...
export default SavePartProcessing;

                ...
                <FlatList
                  ...
                  renderItem={({item}) => (
                    <TouchableOpacity
                      ...
                      onPress={() =>
                        handleSelectCompany(item, companyList[item])
                      }>
                      ...
                      <View style={styles.companyModalItemContent}>
                        <View
                          style={[
                            ...
                            {backgroundColor: item.Colors.color2},
                          ]}>
                          <Text style={styles.companyModalCircleText}>

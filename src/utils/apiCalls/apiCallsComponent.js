...
export async function LoadAllBillGenerationList(jsonValue) {
    ...
    console.log("URL", Environment.uri + "billgenerationapi/loadAllBillGeneration");
...
export async function LoadAllWorkOrderBuyerPoList(jsonValue) {
    ...
    console.log("URL", Environment.uri + "workorderstyleapi/loadAllWorkOrderBuyerpos");
...
export async function LoadAllWorkOrderStylesList(jsonValue) {
    ...
    console.log("URL", Environment.uri + "workorderstyleapi/loadAllWorkOrderStyles");
...
export async function getBillGenerationCreateList(jsonValue) {
    ...
    console.log("URL", Environment.uri + "billgenerationapi/createBillGeneration");
...
export async function getBillGenerationBarcodeCreateList(jsonValue) {
    ...
    await fetch(Environment.uri + "buyerpoapicon/billgenerationcreateAPI",
...
export async function validateBillGenerationBarcode(jsonValue) {
    ...
    console.log("URL", Environment.uri + "buyerpoapicon/checkMasterBoxBarcodeExist");
    await fetch(Environment.uri + "buyerpoapicon/checkMasterBoxBarcodeExist",
...
export async function getWorkOrderStyleCreate(jsonValue) {
    ...
    console.log("URL", Environment.uri + "workorderstyleapi/createWorkorderStyle");
...
export async function getCreateStyleTOStyleList(jsonValue) {
    ...
    console.log("URL", Environment.uri + "styletransferapi/getStylesFromLocation");
...
export async function getEditDetailsWorkOrderBuyerPo1(jsonValue) {
    ...
    console.log("url ==>", Environment.uri + "workorderstyleapi/workorderBuyerpoView")
